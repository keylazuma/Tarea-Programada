...
VALUES('2020-09-21',01010101,401250648,'Crema antiarrugas Neutrogena',2,13,0, 'credito', 25000, 'Juan Rodríguez'),
  ('2023-08-12',01010101,107890996,'Crema antiarrugas Neutrogena',2,13,4, 'efectivo', 25000, 'Alejandro Lopez'),
  ('2022-07-01',01010101,3101954367,'Crema antiarrugas Neutrogena',2,13,8, 'credito', 25000, 'Ezequiel Dávalos'),
  ('2022-06-15',01010101,507890123,'Crema antiarrugas Neutrogena',2,0,0, 'efectivo', 25000, 'Ezequiel Dávalos'),
  ('2023-01-19',01010101,207890567,'Crema antiarrugas Neutrogena',2,13,25, 'efectivo', 25000, 'Ezequiel Dávalos'),
  ('2023-04-30',01010101,3101659380,'Crema antiarrugas Neutrogena',2,1,75, 'credito', 25000, 'Ezequiel Dávalos'),
  ('2022-09-04',01010101,405670123,'Crema antiarrugas Neutrogena',2,1,0, 'efectivo', 25000, 'Ezequiel Dávalos')
